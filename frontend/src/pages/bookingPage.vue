              ...
              <div class="p-6">
                ...
                <div v-else>
                  <div
                    ...
                    :key="index"
                    class="mb-6 border-b pb-6 last:border-b-0 flex flex-col md:flex-row items-center gap-6"
                  >
                    <!-- Package Image -->
                    <img
                    ...
                    <div class="flex-grow w-full">
                      ...
                      <div class="mt-4 flex flex-col md:flex-row md:justify-between items-center">
                        ...
                        <button
                          class="w-full md:w-auto bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition mt-3 md:mt-0"
